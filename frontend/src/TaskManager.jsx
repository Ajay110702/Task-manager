...
const fetchAllTasks=async()=>{
  ...
  return (
    <div className='d-flex flex-column align-items-center w-50 m-auto mt-5'>
        ...
        <div className='d-flex justify-content-betweeen align-items-center mb-4 w-100'>
        <div className='input-group flex-grow-1 me-2'>
            <input type="text" value={input} className='form-control me-1' placeholder='Add a new task'
